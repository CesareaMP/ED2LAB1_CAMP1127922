...
namespace ED2LAB1_CAMP1127922
{
    internal class Aritmetica {
        ...
        //    }
        private string contexto = "a bcdef gh ijklmnopqrstuvw xyzABCDEFGHIJKLMNOPQRSTUVWXYZáéíóúÁÉ ÍÓÚüÜñÑ 1234567890!¡\"#$% &'()*+,-./:;<=>?@[\\\\]^_`{|}~¿?¡ abcde fghijklmnopq  rstu vwxyzABCDEF GHIJKLMN OPQRSTUVWXYZáéíóúÁÉÍÓ ÚüÜñÑ12 3 4567890!¡\"#$%&'()*+,-./ :;<=>?@[\\  \\]^_`{|}~¿?} abcdefghij klmnopqr s t uvwxyzABCDEFGHI JKLMNOPQRST UVWXYZá éí óúÁÉÍÓ Úü ÜñÑ12 34 567890!¡\"#$%&'()*+,-./:;<=>?@[\\\\]^_`{|}~¿?}";
        string[,] tabla;
        public Aritmetica() {
